...
export class CreditsScene extends Phaser.Scene {
    ...
    create() {
        //Background
        this.add.image(0,0,'creditsBackground').setOrigin(0).setScale(0.8667388949, 0.96930533117).setDepth(0);
        ...
        let samuelName = this.add.text(500, 330, 'Sammy Fingerblaster!', {
            fontFamily: 'BadComic-Regular',
            color: '#F8C8DC',
            fontSize: '35px'
        }).setOrigin(0.5).setDepth(1);

        this.add.text(400, 440, 'Thank you for playing!', {
            fontFamily: 'BadComic-Regular',
            color: 'black',
            fontSize: '70px'
        }).setOrigin(0.5).setDepth(1);
        ...
        const emitter1 = this.add.particles(750, 440, 'creditsBtn', {
        ...
        const emitter2 = this.add.particles(750, 440, 'redExcl', {
            speed: { min: 200, max: 300 },
            lifespan: 1000,
            scale: { start: 0.5, end: 0.25 },
            alpha: { start: 0.1, end: 0.9 },
        ...
        const emitter3 = this.add.particles(750, 440, 'grayExcl', {
            speed: { min: 200, max: 300 },
            lifespan: 1000,
            scale: { start: 0.5, end: 0.25 },
            alpha: { start: 0.1, end: 0.9 },
        ...
        const emitter4 = this.add.particles(50, 440, 'creditsBtn', {
            speed: { min: 200, max: 300 },
            lifespan: 1000,
            scale: { start: 0.5, end: 0.25 },
            alpha: { start: 0.1, end: 0.9 },
        ...
        const emitter5 = this.add.particles(50, 440, 'redExcl', {
            speed: { min: 200, max: 300 },
            lifespan: 1000,
            scale: { start: 0.5, end: 0.25 },
            alpha: { start: 0.1, end: 0.9 },
        ...
        const emitter6 = this.add.particles(50, 440, 'grayExcl', {
            speed: { min: 200, max: 300 },
            lifespan: 1000,
            scale: { start: 0.5, end: 0.25 },
            alpha: { start: 0.1, end: 0.9 },
